...
func (app *Config) SubscribeToPlan(w http.ResponseWriter, r *http.Request) {
	...
	go func() {
		...
		//test app error chan
		app.ErrorChan <- errors.New("some custom err")
	...
	if err != nil {
		app.Session.Put(r.Context(), "error", "Error geting user from Dataase!")
		http.Redirect(w, r, "/members/plan", http.StatusSeeOther)
		return
	}
...
func (app *Config) getInvoice(u data.User, plan *data.Plan) (string, error) {
	app.InfoLog.Println("amount ", plan.PlanAmountFormatted)
